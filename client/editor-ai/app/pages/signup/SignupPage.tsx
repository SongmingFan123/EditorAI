    ...
    <div className="min-h-screen flex items-center justify-center flex-col">
      ...
      >
        <div className="flex justify-center w-full">
          <Image src="/editorai.svg" alt="Logo" width={100} height={100} />
        </div>
        <h1
        ...
        <form
          onSubmit={handleForm}
          className="w-full flex flex-col bg-brand-tan items-center"
        >
          <div className="mb-4">
            {signupFailed && (
            ...
            ></div>
            <input
              className="w-full border p-2 pl-3 placeholder-color custom-border-opacity"
              style={{
                width: "341px",
                height: "42px",
                top: "413px",
          ...
          <button
            className="bg-main-color text-white px-4 py-2 hover:bg-red-800 items-center"
            style={{
              width: "252px",
              height: "54px",
              ...
              //lineHeight: '33px',
              background:
                "radial-gradient(50% 50% at 50% 50%, #9F4949 0%, #801212 100%)",
              borderRadius: "12px",
            }}
            type="submit"
            //onClick={handleLogin}
