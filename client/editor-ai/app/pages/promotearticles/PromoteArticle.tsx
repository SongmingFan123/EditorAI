...
const PromoteArticle = () => {
  ...
  const [copyText, setCopyText] = useState<string>(
    "Click the refresh button to generate a new social media copy.",
  );
  ...
  return (
    <div className="p-10 bg-brand-tan min-h-screen">
      <h1 className="text-3xl text-center m-5 mb-2 font-newsreader">
        Promote your Project: {documentTitle}
      </h1>
