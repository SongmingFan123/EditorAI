...
const DocumentCreation: React.FC<Props> = ({
  setDocumentName,
  handleCreateDocument,
  setShowPopup,
  documentName,
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50 flex items-center justify-center">
      <div
        className="bg-brand-tan p-8 rounded-xl w-full max-w-2xl shadow-lg w-96"
        style={{
          minHeight: "40vh",
        ...
        <div className="popup-content flex flex-col items-center justify-center space-y-4">
          {createDocumentFailed && (
            <h1 className="text-red-500 mb-4">
              That document name already exists
            </h1>
          )}
          <>
            ...
            <div className="flex flex-row justify-center gap-10 ">
              <button
                ...
                className=" font-poppins rounded-full border border-neutral-300 py-4 px-10
            bg-main-color hover:bg-red-800 text-white text-lg w-auto"
                style={{
                  background:
